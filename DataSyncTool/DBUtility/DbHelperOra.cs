    ...
    public abstract class DbHelperOra
    {
        ...
        private static void PrepareCommand(OracleCommand cmd, OracleConnection conn, OracleTransaction trans, string cmdText, OracleParameter[] cmdParms)
        {
            ...
            if (cmdParms != null)
            {
                ...
                {
                    if ((parm.DbType == DbType.Date || parm.DbType == DbType.DateTime || parm.DbType == DbType.DateTime2) && parm.Value != null)
                    {
                        DateTime dt;
                        DateTime.TryParse(parm.Value.ToString(), out dt);
                        if (dt <= new DateTime(1950, 1, 1))
