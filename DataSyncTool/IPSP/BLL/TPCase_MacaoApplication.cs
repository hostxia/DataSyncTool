...
{
	/// <summary>
	/// TPCase_MacaoApplication
	/// </summary>
	public partial class TPCase_MacaoApplication
	{
		private readonly IPSP.DAL.TPCase_MacaoApplication dal=new IPSP.DAL.TPCase_MacaoApplication();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TPCase_MacaoApplication GetModelByCache(int n_CaseID)
		{
			
			string CacheKey = "TPCase_MacaoApplicationModel-" + n_CaseID;
			...
			return (IPSP.Model.TPCase_MacaoApplication)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_MacaoApplication> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_MacaoApplication> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TPCase_MacaoApplication> modelList = new List<IPSP.Model.TPCase_MacaoApplication>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TPCase_MacaoApplication model;
