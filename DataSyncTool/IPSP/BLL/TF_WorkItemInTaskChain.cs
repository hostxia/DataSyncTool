...
{
	/// <summary>
	/// TF_WorkItemInTaskChain
	/// </summary>
	public partial class TF_WorkItemInTaskChain
	{
		private readonly IPSP.DAL.TF_WorkItemInTaskChain dal=new IPSP.DAL.TF_WorkItemInTaskChain();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TF_WorkItemInTaskChain GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TF_WorkItemInTaskChainModel-" + g_ID;
			...
			return (IPSP.Model.TF_WorkItemInTaskChain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_WorkItemInTaskChain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_WorkItemInTaskChain> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TF_WorkItemInTaskChain> modelList = new List<IPSP.Model.TF_WorkItemInTaskChain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TF_WorkItemInTaskChain model;
