...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TCase_Base dal=new IPSP.DAL.TCase_Base();
		public TCase_Base()
		{}
		#region  BasicMethod
		...
		{
			return dal.Exists(n_CoopAgencyFromID,n_CoopAgencyToID,n_ClientID,n_IntroID,ObjectType,n_ContractID,n_SecurityLevelID,n_CaseID);
		}
		...
		public bool Delete(int n_CoopAgencyFromID,int n_CoopAgencyToID,int n_ClientID,int n_IntroID,int ObjectType,int n_ContractID,int n_SecurityLevelID,int n_CaseID)
		{
			...
			return dal.Delete(n_CoopAgencyFromID,n_CoopAgencyToID,n_ClientID,n_IntroID,ObjectType,n_ContractID,n_SecurityLevelID,n_CaseID);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCase_Base GetModelByCache(int n_CaseID)
		{
			
			string CacheKey = "TCase_BaseModel-" + n_CaseID;
			...
			return (IPSP.Model.TCase_Base)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_Base> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_Base> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCase_Base> modelList = new List<IPSP.Model.TCase_Base>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCase_Base model;
