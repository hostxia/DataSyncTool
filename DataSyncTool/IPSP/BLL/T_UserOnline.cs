...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.T_UserOnline dal=new IPSP.DAL.T_UserOnline();
		public T_UserOnline()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.T_UserOnline GetModelByCache(decimal n_ID)
		{
			
			string CacheKey = "T_UserOnlineModel-" + n_ID;
			...
			return (IPSP.Model.T_UserOnline)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.T_UserOnline> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.T_UserOnline> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.T_UserOnline> modelList = new List<IPSP.Model.T_UserOnline>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.T_UserOnline model;
