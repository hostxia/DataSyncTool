...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TPCase_WriteInfo dal=new IPSP.DAL.TPCase_WriteInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TPCase_WriteInfo GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TPCase_WriteInfoModel-" + n_ID;
			...
			return (IPSP.Model.TPCase_WriteInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_WriteInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_WriteInfo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TPCase_WriteInfo> modelList = new List<IPSP.Model.TPCase_WriteInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TPCase_WriteInfo model;
