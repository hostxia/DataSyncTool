...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TTCase_ConflictInfo dal=new IPSP.DAL.TTCase_ConflictInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_ConflictInfo GetModelByCache(int n_CaseID)
		{
			
			string CacheKey = "TTCase_ConflictInfoModel-" + n_CaseID;
			...
			return (IPSP.Model.TTCase_ConflictInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_ConflictInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_ConflictInfo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_ConflictInfo> modelList = new List<IPSP.Model.TTCase_ConflictInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_ConflictInfo model;
