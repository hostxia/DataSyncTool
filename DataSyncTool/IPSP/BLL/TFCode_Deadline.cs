...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TFCode_Deadline dal=new IPSP.DAL.TFCode_Deadline();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TFCode_Deadline GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TFCode_DeadlineModel-" + g_ID;
			...
			return (IPSP.Model.TFCode_Deadline)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_Deadline> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_Deadline> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TFCode_Deadline> modelList = new List<IPSP.Model.TFCode_Deadline>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TFCode_Deadline model;
