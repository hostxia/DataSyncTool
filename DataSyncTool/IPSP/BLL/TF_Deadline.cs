...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TF_Deadline dal=new IPSP.DAL.TF_Deadline();
		public TF_Deadline()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TF_Deadline GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TF_DeadlineModel-" + n_ID;
			...
			return (IPSP.Model.TF_Deadline)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_Deadline> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_Deadline> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TF_Deadline> modelList = new List<IPSP.Model.TF_Deadline>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TF_Deadline model;
