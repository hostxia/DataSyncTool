...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TF_Task dal=new IPSP.DAL.TF_Task();
		public TF_Task()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TF_Task GetModelByCache(int n_Num)
		{
			
			string CacheKey = "TF_TaskModel-" + n_Num;
			...
			return (IPSP.Model.TF_Task)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_Task> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_Task> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TF_Task> modelList = new List<IPSP.Model.TF_Task>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TF_Task model;
