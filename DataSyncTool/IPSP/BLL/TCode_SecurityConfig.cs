...
{
	/// <summary>
	/// TCode_SecurityConfig
	/// </summary>
	public partial class TCode_SecurityConfig
	{
		private readonly IPSP.DAL.TCode_SecurityConfig dal=new IPSP.DAL.TCode_SecurityConfig();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCode_SecurityConfig GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TCode_SecurityConfigModel-" + n_ID;
			...
			return (IPSP.Model.TCode_SecurityConfig)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCode_SecurityConfig> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCode_SecurityConfig> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCode_SecurityConfig> modelList = new List<IPSP.Model.TCode_SecurityConfig>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCode_SecurityConfig model;
