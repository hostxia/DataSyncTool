...
{
	/// <summary>
	/// TTCase_OppositePersons
	/// </summary>
	public partial class TTCase_OppositePersons
	{
		private readonly IPSP.DAL.TTCase_OppositePersons dal=new IPSP.DAL.TTCase_OppositePersons();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_OppositePersons GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_OppositePersonsModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_OppositePersons)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_OppositePersons> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_OppositePersons> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_OppositePersons> modelList = new List<IPSP.Model.TTCase_OppositePersons>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_OppositePersons model;
