...
{
	/// <summary>
	/// TCase_CaseCustomField
	/// </summary>
	public partial class TCase_CaseCustomField
	{
		private readonly IPSP.DAL.TCase_CaseCustomField dal=new IPSP.DAL.TCase_CaseCustomField();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCase_CaseCustomField GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TCase_CaseCustomFieldModel-" + n_ID;
			...
			return (IPSP.Model.TCase_CaseCustomField)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_CaseCustomField> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_CaseCustomField> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCase_CaseCustomField> modelList = new List<IPSP.Model.TCase_CaseCustomField>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCase_CaseCustomField model;
