...
{
	/// <summary>
	/// TCstmr_ClientFeePolicy
	/// </summary>
	public partial class TCstmr_ClientFeePolicy
	{
		private readonly IPSP.DAL.TCstmr_ClientFeePolicy dal=new IPSP.DAL.TCstmr_ClientFeePolicy();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCstmr_ClientFeePolicy GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TCstmr_ClientFeePolicyModel-" + n_ID;
			...
			return (IPSP.Model.TCstmr_ClientFeePolicy)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCstmr_ClientFeePolicy> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCstmr_ClientFeePolicy> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCstmr_ClientFeePolicy> modelList = new List<IPSP.Model.TCstmr_ClientFeePolicy>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCstmr_ClientFeePolicy model;
