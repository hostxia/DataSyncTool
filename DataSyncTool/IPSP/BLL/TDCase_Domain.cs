...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TDCase_Domain dal=new IPSP.DAL.TDCase_Domain();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TDCase_Domain GetModelByCache(int n_CaseID)
		{
			
			string CacheKey = "TDCase_DomainModel-" + n_CaseID;
			...
			return (IPSP.Model.TDCase_Domain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TDCase_Domain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TDCase_Domain> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TDCase_Domain> modelList = new List<IPSP.Model.TDCase_Domain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TDCase_Domain model;
