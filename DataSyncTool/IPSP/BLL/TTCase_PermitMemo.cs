...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TTCase_PermitMemo dal=new IPSP.DAL.TTCase_PermitMemo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_PermitMemo GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_PermitMemoModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_PermitMemo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_PermitMemo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_PermitMemo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_PermitMemo> modelList = new List<IPSP.Model.TTCase_PermitMemo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_PermitMemo model;
