...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TR_Remind dal=new IPSP.DAL.TR_Remind();
		public TR_Remind()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TR_Remind GetModelByCache(int n_Num)
		{
			
			string CacheKey = "TR_RemindModel-" + n_Num;
			...
			return (IPSP.Model.TR_Remind)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TR_Remind> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TR_Remind> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TR_Remind> modelList = new List<IPSP.Model.TR_Remind>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TR_Remind model;
