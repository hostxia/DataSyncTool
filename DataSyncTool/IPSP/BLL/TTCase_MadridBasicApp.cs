...
{
	/// <summary>
	/// TTCase_MadridBasicApp
	/// </summary>
	public partial class TTCase_MadridBasicApp
	{
		private readonly IPSP.DAL.TTCase_MadridBasicApp dal=new IPSP.DAL.TTCase_MadridBasicApp();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_MadridBasicApp GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_MadridBasicAppModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_MadridBasicApp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_MadridBasicApp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_MadridBasicApp> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_MadridBasicApp> modelList = new List<IPSP.Model.TTCase_MadridBasicApp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_MadridBasicApp model;
