...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TTCase_ChangeItems dal=new IPSP.DAL.TTCase_ChangeItems();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_ChangeItems GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_ChangeItemsModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_ChangeItems)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_ChangeItems> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_ChangeItems> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_ChangeItems> modelList = new List<IPSP.Model.TTCase_ChangeItems>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_ChangeItems model;
