...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TF_TaskChain dal=new IPSP.DAL.TF_TaskChain();
		public TF_TaskChain()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TF_TaskChain GetModelByCache(int n_Num)
		{
			
			string CacheKey = "TF_TaskChainModel-" + n_Num;
			...
			return (IPSP.Model.TF_TaskChain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_TaskChain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_TaskChain> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TF_TaskChain> modelList = new List<IPSP.Model.TF_TaskChain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TF_TaskChain model;
