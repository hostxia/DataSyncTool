...
{
	/// <summary>
	/// TF_CustomConditionInTaskChain
	/// </summary>
	public partial class TF_CustomConditionInTaskChain
	{
		private readonly IPSP.DAL.TF_CustomConditionInTaskChain dal=new IPSP.DAL.TF_CustomConditionInTaskChain();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TF_CustomConditionInTaskChain GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TF_CustomConditionInTaskChainModel-" + g_ID;
			...
			return (IPSP.Model.TF_CustomConditionInTaskChain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_CustomConditionInTaskChain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_CustomConditionInTaskChain> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TF_CustomConditionInTaskChain> modelList = new List<IPSP.Model.TF_CustomConditionInTaskChain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TF_CustomConditionInTaskChain model;
