...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TCase_CaseRenewConn dal=new IPSP.DAL.TCase_CaseRenewConn();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCase_CaseRenewConn GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TCase_CaseRenewConnModel-" + n_ID;
			...
			return (IPSP.Model.TCase_CaseRenewConn)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_CaseRenewConn> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_CaseRenewConn> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCase_CaseRenewConn> modelList = new List<IPSP.Model.TCase_CaseRenewConn>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCase_CaseRenewConn model;
