...
{
	/// <summary>
	/// TFCode_TaskGenerateFee
	/// </summary>
	public partial class TFCode_TaskGenerateFee
	{
		private readonly IPSP.DAL.TFCode_TaskGenerateFee dal=new IPSP.DAL.TFCode_TaskGenerateFee();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TFCode_TaskGenerateFee GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TFCode_TaskGenerateFeeModel-" + g_ID;
			...
			return (IPSP.Model.TFCode_TaskGenerateFee)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_TaskGenerateFee> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_TaskGenerateFee> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TFCode_TaskGenerateFee> modelList = new List<IPSP.Model.TFCode_TaskGenerateFee>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TFCode_TaskGenerateFee model;
