...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TPCase_AnnFeeInfo dal=new IPSP.DAL.TPCase_AnnFeeInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TPCase_AnnFeeInfo GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TPCase_AnnFeeInfoModel-" + n_ID;
			...
			return (IPSP.Model.TPCase_AnnFeeInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_AnnFeeInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_AnnFeeInfo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TPCase_AnnFeeInfo> modelList = new List<IPSP.Model.TPCase_AnnFeeInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TPCase_AnnFeeInfo model;
