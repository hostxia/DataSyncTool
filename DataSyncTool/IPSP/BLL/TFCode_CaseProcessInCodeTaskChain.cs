...
{
	/// <summary>
	/// TFCode_CaseProcessInCodeTaskChain
	/// </summary>
	public partial class TFCode_CaseProcessInCodeTaskChain
	{
		private readonly IPSP.DAL.TFCode_CaseProcessInCodeTaskChain dal=new IPSP.DAL.TFCode_CaseProcessInCodeTaskChain();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TFCode_CaseProcessInCodeTaskChain GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TFCode_CaseProcessInCodeTaskChainModel-" + g_ID;
			...
			return (IPSP.Model.TFCode_CaseProcessInCodeTaskChain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_CaseProcessInCodeTaskChain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_CaseProcessInCodeTaskChain> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TFCode_CaseProcessInCodeTaskChain> modelList = new List<IPSP.Model.TFCode_CaseProcessInCodeTaskChain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TFCode_CaseProcessInCodeTaskChain model;
