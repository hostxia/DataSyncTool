...
{
	/// <summary>
	/// TTCase_CancellationInfo
	/// </summary>
	public partial class TTCase_CancellationInfo
	{
		private readonly IPSP.DAL.TTCase_CancellationInfo dal=new IPSP.DAL.TTCase_CancellationInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_CancellationInfo GetModelByCache(int n_CaseID)
		{
			
			string CacheKey = "TTCase_CancellationInfoModel-" + n_CaseID;
			...
			return (IPSP.Model.TTCase_CancellationInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_CancellationInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_CancellationInfo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_CancellationInfo> modelList = new List<IPSP.Model.TTCase_CancellationInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_CancellationInfo model;
