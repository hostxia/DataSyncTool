...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TTCase_LawInfo dal=new IPSP.DAL.TTCase_LawInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_LawInfo GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_LawInfoModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_LawInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_LawInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_LawInfo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_LawInfo> modelList = new List<IPSP.Model.TTCase_LawInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_LawInfo model;
