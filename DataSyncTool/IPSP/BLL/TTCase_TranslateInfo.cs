...
{
	/// <summary>
	/// TTCase_TranslateInfo
	/// </summary>
	public partial class TTCase_TranslateInfo
	{
		private readonly IPSP.DAL.TTCase_TranslateInfo dal=new IPSP.DAL.TTCase_TranslateInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_TranslateInfo GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_TranslateInfoModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_TranslateInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_TranslateInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_TranslateInfo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_TranslateInfo> modelList = new List<IPSP.Model.TTCase_TranslateInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_TranslateInfo model;
