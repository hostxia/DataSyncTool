...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TF_TaskCheck dal=new IPSP.DAL.TF_TaskCheck();
		public TF_TaskCheck()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TF_TaskCheck GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TF_TaskCheckModel-" + g_ID;
			...
			return (IPSP.Model.TF_TaskCheck)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_TaskCheck> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TF_TaskCheck> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TF_TaskCheck> modelList = new List<IPSP.Model.TF_TaskCheck>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TF_TaskCheck model;
