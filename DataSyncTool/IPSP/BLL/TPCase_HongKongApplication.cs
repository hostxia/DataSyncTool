...
{
	/// <summary>
	/// TPCase_HongKongApplication
	/// </summary>
	public partial class TPCase_HongKongApplication
	{
		private readonly IPSP.DAL.TPCase_HongKongApplication dal=new IPSP.DAL.TPCase_HongKongApplication();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TPCase_HongKongApplication GetModelByCache(int n_CaseID)
		{
			
			string CacheKey = "TPCase_HongKongApplicationModel-" + n_CaseID;
			...
			return (IPSP.Model.TPCase_HongKongApplication)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_HongKongApplication> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_HongKongApplication> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TPCase_HongKongApplication> modelList = new List<IPSP.Model.TPCase_HongKongApplication>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TPCase_HongKongApplication model;
