...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TTCase_OtherImage dal=new IPSP.DAL.TTCase_OtherImage();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_OtherImage GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_OtherImageModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_OtherImage)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_OtherImage> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_OtherImage> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_OtherImage> modelList = new List<IPSP.Model.TTCase_OtherImage>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_OtherImage model;
