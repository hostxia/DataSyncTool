...
{
	/// <summary>
	/// TPCase_TranslateInfo
	/// </summary>
	public partial class TPCase_TranslateInfo
	{
		private readonly IPSP.DAL.TPCase_TranslateInfo dal=new IPSP.DAL.TPCase_TranslateInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TPCase_TranslateInfo GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TPCase_TranslateInfoModel-" + n_ID;
			...
			return (IPSP.Model.TPCase_TranslateInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_TranslateInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TPCase_TranslateInfo> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TPCase_TranslateInfo> modelList = new List<IPSP.Model.TPCase_TranslateInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TPCase_TranslateInfo model;
