...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TCode_FlowNoRule dal=new IPSP.DAL.TCode_FlowNoRule();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCode_FlowNoRule GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TCode_FlowNoRuleModel-" + n_ID;
			...
			return (IPSP.Model.TCode_FlowNoRule)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCode_FlowNoRule> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCode_FlowNoRule> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCode_FlowNoRule> modelList = new List<IPSP.Model.TCode_FlowNoRule>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCode_FlowNoRule model;
