...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:50:05   N/A    初版
*
...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TRCode_RemindMode dal=new IPSP.DAL.TRCode_RemindMode();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TRCode_RemindMode GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TRCode_RemindModeModel-" + g_ID;
			...
			return (IPSP.Model.TRCode_RemindMode)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TRCode_RemindMode> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TRCode_RemindMode> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TRCode_RemindMode> modelList = new List<IPSP.Model.TRCode_RemindMode>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TRCode_RemindMode model;
