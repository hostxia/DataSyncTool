...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TCase_CaseRelative dal=new IPSP.DAL.TCase_CaseRelative();
		...
		{
			return dal.Exists(n_CaseIDA,n_CaseIDB,n_ID);
		}
		...
		public bool Delete(int n_CaseIDA,int n_CaseIDB,int n_ID)
		{
			...
			return dal.Delete(n_CaseIDA,n_CaseIDB,n_ID);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCase_CaseRelative GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TCase_CaseRelativeModel-" + n_ID;
			...
			return (IPSP.Model.TCase_CaseRelative)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_CaseRelative> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCase_CaseRelative> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCase_CaseRelative> modelList = new List<IPSP.Model.TCase_CaseRelative>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCase_CaseRelative model;
