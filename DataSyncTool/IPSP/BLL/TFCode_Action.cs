...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TFCode_Action dal=new IPSP.DAL.TFCode_Action();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TFCode_Action GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TFCode_ActionModel-" + n_ID;
			...
			return (IPSP.Model.TFCode_Action)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_Action> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_Action> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TFCode_Action> modelList = new List<IPSP.Model.TFCode_Action>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TFCode_Action model;
