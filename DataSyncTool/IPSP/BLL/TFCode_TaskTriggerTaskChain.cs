...
{
	/// <summary>
	/// TFCode_TaskTriggerTaskChain
	/// </summary>
	public partial class TFCode_TaskTriggerTaskChain
	{
		private readonly IPSP.DAL.TFCode_TaskTriggerTaskChain dal=new IPSP.DAL.TFCode_TaskTriggerTaskChain();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TFCode_TaskTriggerTaskChain GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TFCode_TaskTriggerTaskChainModel-" + g_ID;
			...
			return (IPSP.Model.TFCode_TaskTriggerTaskChain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_TaskTriggerTaskChain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TFCode_TaskTriggerTaskChain> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TFCode_TaskTriggerTaskChain> modelList = new List<IPSP.Model.TFCode_TaskTriggerTaskChain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TFCode_TaskTriggerTaskChain model;
