...
namespace DataSyncTool.IPSP.BLL
{
	...
	{
		private readonly IPSP.DAL.TTCase_Goods dal=new IPSP.DAL.TTCase_Goods();
		public TTCase_Goods()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TTCase_Goods GetModelByCache(int n_ID)
		{
			
			string CacheKey = "TTCase_GoodsModel-" + n_ID;
			...
			return (IPSP.Model.TTCase_Goods)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_Goods> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TTCase_Goods> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TTCase_Goods> modelList = new List<IPSP.Model.TTCase_Goods>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TTCase_Goods model;
