...
{
	/// <summary>
	/// TCode_AutoDemandParams
	/// </summary>
	public partial class TCode_AutoDemandParams
	{
		private readonly IPSP.DAL.TCode_AutoDemandParams dal=new IPSP.DAL.TCode_AutoDemandParams();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public IPSP.Model.TCode_AutoDemandParams GetModelByCache(Guid g_ID)
		{
			
			string CacheKey = "TCode_AutoDemandParamsModel-" + g_ID;
			...
			return (IPSP.Model.TCode_AutoDemandParams)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCode_AutoDemandParams> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IPSP.Model.TCode_AutoDemandParams> DataTableToList(DataTable dt)
		{
			List<IPSP.Model.TCode_AutoDemandParams> modelList = new List<IPSP.Model.TCode_AutoDemandParams>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IPSP.Model.TCode_AutoDemandParams model;
