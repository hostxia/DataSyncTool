...
namespace DataSyncTool.DBIPS4_Import
{
    ...
    public partial class TCstmr_AgencyConAddress : XPLiteObject
    {
        int fn_ID;
        [Key(true)]
        public int n_ID
        ...
        TCstmr_AgencyContact fn_ContactID;
        [Association(@"TCstmr_AgencyConAddressReferencesTCstmr_AgencyContact")]
        public TCstmr_AgencyContact n_ContactID
        {
            get { return fn_ContactID; }
            set { SetPropertyValue<TCstmr_AgencyContact>("n_ContactID", ref fn_ContactID, value); }
        }
        int fn_Country;
