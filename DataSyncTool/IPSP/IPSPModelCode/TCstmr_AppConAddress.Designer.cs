...
namespace DataSyncTool.DBIPS4_Import
{
    ...
    public partial class TCstmr_AppConAddress : XPLiteObject
    {
        int fn_ID;
        [Key(true)]
        public int n_ID
        ...
        TCstmr_AppContact fn_ContactID;
        [Association(@"TCstmr_AppConAddressReferencesTCstmr_AppContact")]
        public TCstmr_AppContact n_ContactID
        {
            get { return fn_ContactID; }
            set { SetPropertyValue<TCstmr_AppContact>("n_ContactID", ref fn_ContactID, value); }
        }
        int fn_Country;
