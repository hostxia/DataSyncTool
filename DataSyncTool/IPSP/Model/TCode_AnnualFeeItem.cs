...
{
	/// <summary>
	/// TCode_AnnualFeeItem:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class TCode_AnnualFeeItem
	{
		...
		#region Model
		private int _n_id;
		private int _n_annualfeecodeid;
		...
		/// 
		/// </summary>
		public int n_AnnualFeeCodeID
		{
			set{ _n_annualfeecodeid=value;}
			get{return _n_annualfeecodeid;}
		}
		/// <summary>
		/// 
		/// </summary>
