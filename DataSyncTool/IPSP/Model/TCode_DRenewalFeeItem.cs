...
{
	/// <summary>
	/// TCode_DRenewalFeeItem:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class TCode_DRenewalFeeItem
	{
		...
		/// 
		/// </summary>
		public int n_DRenFeeCodeID
		{
			set{ _n_drenfeecodeid=value;}
			get{return _n_drenfeecodeid;}
		}
		/// <summary>
		/// 
		/// </summary>
