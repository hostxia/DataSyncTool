...
{
	/// <summary>
	/// TFCode_CaseProcessInCodeTaskChain:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class TFCode_CaseProcessInCodeTaskChain
	{
		...
		private int _n_codecaseprocessid;
		private int _n_codecaseprocessitemid;
		private string _s_when;
		/// <summary>
		/// 
		/// </summary>
		public Guid g_ID
		...
		{
			set{ _n_codecaseprocessid=value;}
			get{return _n_codecaseprocessid;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			set{ _n_codecaseprocessitemid=value;}
			get{return _n_codecaseprocessitemid;}
		}
		/// <summary>
		/// 
		/// </summary>
