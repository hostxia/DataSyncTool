...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:49:32   N/A    初版
*
...
{
	/// <summary>
	/// TPCase_OrigPatInfo:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class TPCase_OrigPatInfo
	{
		...
		{
			set{ _n_origregcountry=value;}
			get{return _n_origregcountry;}
		}
		/// <summary>
		/// 
		/// </summary>
