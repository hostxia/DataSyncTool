...
{
	/// <summary>
	/// TFCode_TaskGenerateFee:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class TFCode_TaskGenerateFee
	{
		...
		private string _s_generatetime;
		private string _s_generatecondition;
		/// <summary>
		/// 
		/// </summary>
		public Guid g_ID
		...
		{
			set{ _s_generatetime=value;}
			get{return _s_generatetime;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			set{ _s_generatecondition=value;}
			get{return _s_generatecondition;}
		}
		#endregion Model
