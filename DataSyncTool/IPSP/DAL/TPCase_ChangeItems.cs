...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TPCase_ChangeItems
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "TPCase_ChangeItems"); 
		}
		...
		public bool Exists(int n_CaseID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TPCase_ChangeItems");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TPCase_ChangeItems model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPCase_ChangeItems(");
			strSql.Append("n_CaseID,n_ProcessID,s_Item,s_BeforeChg,s_AfterChg,s_Notes)");
			...
			parameters[2].Value = model.s_Item;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TPCase_ChangeItems model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPCase_ChangeItems set ");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TPCase_ChangeItems ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TPCase_ChangeItems GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_CaseID,n_ProcessID,s_Item,s_BeforeChg,s_AfterChg,s_Notes from TPCase_ChangeItems ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TPCase_ChangeItems model=new IPSP.Model.TPCase_ChangeItems();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TPCase_ChangeItems DataRowToModel(DataRow row)
		{
			IPSP.Model.TPCase_ChangeItems model=new IPSP.Model.TPCase_ChangeItems();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_CaseID,n_ProcessID,s_Item,s_BeforeChg,s_AfterChg,s_Notes ");
			strSql.Append(" FROM TPCase_ChangeItems ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_CaseID,n_ProcessID,s_Item,s_BeforeChg,s_AfterChg,s_Notes ");
			strSql.Append(" FROM TPCase_ChangeItems ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPCase_ChangeItems T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TPCase_ChangeItems";
			parameters[1].Value = "n_ID";
