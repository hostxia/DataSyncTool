/**  版本信息模板在安装目录下，可自行修改。
* TCstmr_ClientContact.cs
*
* 功 能： N/A
* 类 名： TCstmr_ClientContact
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:47:47   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TCstmr_ClientContact
	/// </summary>
	public partial class TCstmr_ClientContact
	{
		public TCstmr_ClientContact()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ClientID", "TCstmr_ClientContact"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int n_ClientID,int n_ContactID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from TCstmr_ClientContact");
			strSql.Append(" where n_ClientID=@n_ClientID and n_ContactID=@n_ContactID ");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_ClientContact model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_ClientContact(");
			strSql.Append("n_ClientID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_ClientContact model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_ClientContact set ");
			...
			parameters[25].Value = model.n_ClientID;
		...
		public bool Delete(int n_ContactID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_ClientContact ");
			strSql.Append(" where n_ContactID=@n_ContactID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ContactID", SqlDbType.Int,4)
			};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int n_ClientID,int n_ContactID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_ClientContact GetModel(int n_ContactID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ContactID,n_ClientID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department from TCstmr_ClientContact ");
			strSql.Append(" where n_ContactID=@n_ContactID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ContactID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_ClientContact model=new IPSP.Model.TCstmr_ClientContact();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_ClientContact DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_ClientContact model=new IPSP.Model.TCstmr_ClientContact();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ContactID,n_ClientID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department ");
			strSql.Append(" FROM TCstmr_ClientContact ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ContactID,n_ClientID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department ");
			strSql.Append(" FROM TCstmr_ClientContact ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_ClientContact T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_ClientContact";
			parameters[1].Value = "n_ContactID";
