...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCstmr_ApplicantFile
	{
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_ApplicantFile ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_AppID,s_Name,s_Description,s_FilePath,dt_EditDate,dt_CreateDate ");
			strSql.Append(" FROM TCstmr_ApplicantFile ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_AppID,s_Name,s_Description,s_FilePath,dt_EditDate,dt_CreateDate ");
			strSql.Append(" FROM TCstmr_ApplicantFile ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM TCstmr_ApplicantFile ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_ApplicantFile T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_ApplicantFile";
