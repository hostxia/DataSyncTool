/**  版本信息模板在安装目录下，可自行修改。
* TCstmr_ClientAddress.cs
*
* 功 能： N/A
* 类 名： TCstmr_ClientAddress
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:47:41   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TCstmr_ClientAddress
	/// </summary>
	public partial class TCstmr_ClientAddress
	{
		public TCstmr_ClientAddress()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ClientID", "TCstmr_ClientAddress"); 
		}
		...
		public bool Exists(int n_ClientID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TCstmr_ClientAddress");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_ClientAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_ClientAddress(");
			strSql.Append("n_ClientID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_TitleAddress)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_ClientAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_ClientAddress set ");
			...
			parameters[7].Value = model.s_TitleAddress;
			parameters[8].Value = model.n_ID;
			parameters[9].Value = model.n_ClientID;
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_ClientAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_ClientAddress GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_ClientID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_TitleAddress from TCstmr_ClientAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_ClientAddress model=new IPSP.Model.TCstmr_ClientAddress();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_ClientAddress DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_ClientAddress model=new IPSP.Model.TCstmr_ClientAddress();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_ClientID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_TitleAddress ");
			strSql.Append(" FROM TCstmr_ClientAddress ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_ClientID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_TitleAddress ");
			strSql.Append(" FROM TCstmr_ClientAddress ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_ClientAddress T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_ClientAddress";
			parameters[1].Value = "n_ID";
