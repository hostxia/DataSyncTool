/**  版本信息模板在安装目录下，可自行修改。
* TCstmr_AgencyContact.cs
*
* 功 能： N/A
* 类 名： TCstmr_AgencyContact
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:47:26   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TCstmr_AgencyContact
	/// </summary>
	public partial class TCstmr_AgencyContact
	{
		public TCstmr_AgencyContact()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_AgencyID", "TCstmr_AgencyContact"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int n_AgencyID,int n_ContactID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from TCstmr_AgencyContact");
			strSql.Append(" where n_AgencyID=@n_AgencyID and n_ContactID=@n_ContactID ");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_AgencyContact model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_AgencyContact(");
			strSql.Append("n_AgencyID,s_FirstName,s_LastName,s_NativeName,s_OtherName,n_Language,s_IPType,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@s_Department", SqlDbType.NVarChar,100)};
			...
			parameters[6].Value = model.s_IPType;
			...
			parameters[24].Value = model.s_Department;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_AgencyContact model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_AgencyContact set ");
			...
			parameters[23].Value = model.s_Department;
			parameters[24].Value = model.n_ContactID;
			parameters[25].Value = model.n_AgencyID;
		...
		public bool Delete(int n_ContactID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_AgencyContact ");
			strSql.Append(" where n_ContactID=@n_ContactID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ContactID", SqlDbType.Int,4)
			};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int n_AgencyID,int n_ContactID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AgencyContact GetModel(int n_ContactID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ContactID,n_AgencyID,s_FirstName,s_LastName,s_NativeName,s_OtherName,n_Language,s_IPType,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department from TCstmr_AgencyContact ");
			strSql.Append(" where n_ContactID=@n_ContactID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ContactID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_AgencyContact model=new IPSP.Model.TCstmr_AgencyContact();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AgencyContact DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_AgencyContact model=new IPSP.Model.TCstmr_AgencyContact();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ContactID,n_AgencyID,s_FirstName,s_LastName,s_NativeName,s_OtherName,n_Language,s_IPType,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department ");
			strSql.Append(" FROM TCstmr_AgencyContact ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ContactID,n_AgencyID,s_FirstName,s_LastName,s_NativeName,s_OtherName,n_Language,s_IPType,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_IPRole,s_Identity,s_Department ");
			strSql.Append(" FROM TCstmr_AgencyContact ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_AgencyContact T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_AgencyContact";
			parameters[1].Value = "n_ContactID";
