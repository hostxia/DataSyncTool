...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCode_AutoDemandParams
	{
		...
		public bool Exists(Guid g_ID)
		{
			...
			strSql.Append("select count(1) from TCode_AutoDemandParams");
		...
		public bool Delete(Guid g_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCode_AutoDemandParams ");
			strSql.Append(" where g_ID=@g_ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@g_ID", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = g_ID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select g_ID,g_CodeAutoDemandID,s_DataType,s_RuleRegex,s_Description,n_Sequence ");
			strSql.Append(" FROM TCode_AutoDemandParams ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCode_AutoDemandParams T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCode_AutoDemandParams";
