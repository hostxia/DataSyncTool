...
{
	/// <summary>
	/// 数据访问类:TFCode_WorkItemInCodeTaskChain
	/// </summary>
	public partial class TFCode_WorkItemInCodeTaskChain
	{
		...
		public bool Exists(Guid g_ID)
		{
			...
			strSql.Append("select count(1) from TFCode_WorkItemInCodeTaskChain");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(IPSP.Model.TFCode_WorkItemInCodeTaskChain model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TFCode_WorkItemInCodeTaskChain(");
			strSql.Append("g_ID,g_CodeTaskChainGuid,n_CodeWorkItemID,s_Description)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TFCode_WorkItemInCodeTaskChain model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TFCode_WorkItemInCodeTaskChain set ");
		...
		public bool Delete(Guid g_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TFCode_WorkItemInCodeTaskChain ");
			strSql.Append(" where g_ID=@g_ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@g_ID", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = g_ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TFCode_WorkItemInCodeTaskChain GetModel(Guid g_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 g_ID,g_CodeTaskChainGuid,n_CodeWorkItemID,s_Description from TFCode_WorkItemInCodeTaskChain ");
			strSql.Append(" where g_ID=@g_ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@g_ID", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = g_ID;

			IPSP.Model.TFCode_WorkItemInCodeTaskChain model=new IPSP.Model.TFCode_WorkItemInCodeTaskChain();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TFCode_WorkItemInCodeTaskChain DataRowToModel(DataRow row)
		{
			IPSP.Model.TFCode_WorkItemInCodeTaskChain model=new IPSP.Model.TFCode_WorkItemInCodeTaskChain();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select g_ID,g_CodeTaskChainGuid,n_CodeWorkItemID,s_Description ");
			strSql.Append(" FROM TFCode_WorkItemInCodeTaskChain ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TFCode_WorkItemInCodeTaskChain T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TFCode_WorkItemInCodeTaskChain";
