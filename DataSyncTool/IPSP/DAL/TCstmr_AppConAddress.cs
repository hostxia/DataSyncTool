/**  版本信息模板在安装目录下，可自行修改。
* TCstmr_AppConAddress.cs
*
* 功 能： N/A
* 类 名： TCstmr_AppConAddress
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:47:32   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TCstmr_AppConAddress
	/// </summary>
	public partial class TCstmr_AppConAddress
	{
		public TCstmr_AppConAddress()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ContactID", "TCstmr_AppConAddress"); 
		}
		...
		public bool Exists(int n_ContactID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TCstmr_AppConAddress");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_AppConAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_AppConAddress(");
			strSql.Append("n_ContactID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,n_Sequence,s_IsMailingAddress,s_TitleAddress)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@s_TitleAddress", SqlDbType.NVarChar,1000)};
			...
			parameters[9].Value = model.s_IsMailingAddress;
			parameters[10].Value = model.s_TitleAddress;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_AppConAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_AppConAddress set ");
			...
			strSql.Append("s_TitleAddress=@s_TitleAddress");
			...
			parameters[9].Value = model.s_TitleAddress;
			parameters[10].Value = model.n_ID;
			parameters[11].Value = model.n_ContactID;
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_AppConAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AppConAddress GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_ContactID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,n_Sequence,s_IsMailingAddress,s_TitleAddress from TCstmr_AppConAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_AppConAddress model=new IPSP.Model.TCstmr_AppConAddress();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AppConAddress DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_AppConAddress model=new IPSP.Model.TCstmr_AppConAddress();
			if (row != null)
			{
				...
				if(row["s_TitleAddress"]!=null)
				{
					model.s_TitleAddress=row["s_TitleAddress"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_ContactID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,n_Sequence,s_IsMailingAddress,s_TitleAddress ");
			strSql.Append(" FROM TCstmr_AppConAddress ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_ContactID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,n_Sequence,s_IsMailingAddress,s_TitleAddress ");
			strSql.Append(" FROM TCstmr_AppConAddress ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_AppConAddress T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_AppConAddress";
			parameters[1].Value = "n_ID";
