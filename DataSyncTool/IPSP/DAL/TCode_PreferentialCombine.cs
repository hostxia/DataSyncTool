...
{
	/// <summary>
	/// 数据访问类:TCode_PreferentialCombine
	/// </summary>
	public partial class TCode_PreferentialCombine
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ID", "TCode_PreferentialCombine"); 
		}
		...
		public bool Exists(int n_ID)
		{
			...
			strSql.Append("select count(1) from TCode_PreferentialCombine");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCode_PreferentialCombine model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCode_PreferentialCombine(");
			strSql.Append("s_IPType,s_Name,s_Notes,s_Creator,dt_CreateDate,s_Editor,dt_EditDate)");
			...
			parameters[3].Value = model.s_Creator;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCode_PreferentialCombine model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCode_PreferentialCombine set ");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCode_PreferentialCombine ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCode_PreferentialCombine GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,s_IPType,s_Name,s_Notes,s_Creator,dt_CreateDate,s_Editor,dt_EditDate from TCode_PreferentialCombine ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCode_PreferentialCombine model=new IPSP.Model.TCode_PreferentialCombine();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCode_PreferentialCombine DataRowToModel(DataRow row)
		{
			IPSP.Model.TCode_PreferentialCombine model=new IPSP.Model.TCode_PreferentialCombine();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,s_IPType,s_Name,s_Notes,s_Creator,dt_CreateDate,s_Editor,dt_EditDate ");
			strSql.Append(" FROM TCode_PreferentialCombine ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,s_IPType,s_Name,s_Notes,s_Creator,dt_CreateDate,s_Editor,dt_EditDate ");
			strSql.Append(" FROM TCode_PreferentialCombine ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCode_PreferentialCombine T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCode_PreferentialCombine";
