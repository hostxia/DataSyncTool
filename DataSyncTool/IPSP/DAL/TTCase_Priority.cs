...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TTCase_Priority
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "TTCase_Priority"); 
		}
		...
		public bool Exists(int n_CaseID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TTCase_Priority");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TTCase_Priority model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TTCase_Priority(");
			strSql.Append("n_CaseID,n_Sequence,s_Priority,n_PCountry,dt_PDate,s_PNum,s_PDocProvided,s_PTransDocProvided,s_Notes)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@s_Priority", SqlDbType.NVarChar,300),
			...
			parameters[4].Value = model.dt_PDate;
			parameters[5].Value = model.s_PNum;
			parameters[6].Value = model.s_PDocProvided;
			parameters[7].Value = model.s_PTransDocProvided;
			parameters[8].Value = model.s_Notes;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TTCase_Priority model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TTCase_Priority set ");
			...
			parameters[2].Value = model.n_PCountry;
			parameters[3].Value = model.dt_PDate;
			parameters[4].Value = model.s_PNum;
			parameters[5].Value = model.s_PDocProvided;
			parameters[6].Value = model.s_PTransDocProvided;
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TTCase_Priority ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TTCase_Priority GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_CaseID,n_Sequence,s_Priority,n_PCountry,dt_PDate,s_PNum,s_PDocProvided,s_PTransDocProvided,s_Notes from TTCase_Priority ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TTCase_Priority model=new IPSP.Model.TTCase_Priority();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TTCase_Priority DataRowToModel(DataRow row)
		{
			IPSP.Model.TTCase_Priority model=new IPSP.Model.TTCase_Priority();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_CaseID,n_Sequence,s_Priority,n_PCountry,dt_PDate,s_PNum,s_PDocProvided,s_PTransDocProvided,s_Notes ");
			strSql.Append(" FROM TTCase_Priority ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_CaseID,n_Sequence,s_Priority,n_PCountry,dt_PDate,s_PNum,s_PDocProvided,s_PTransDocProvided,s_Notes ");
			strSql.Append(" FROM TTCase_Priority ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TTCase_Priority T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TTCase_Priority";
			parameters[1].Value = "n_ID";
