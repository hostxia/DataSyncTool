...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCstmr_AppAddress
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_AppID", "TCstmr_AppAddress"); 
		}
		...
		public bool Exists(int n_AppID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TCstmr_AppAddress");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_AppAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_AppAddress(");
			strSql.Append("n_AppID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_TitleAddress)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_AppAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_AppAddress set ");
			...
			parameters[6].Value = model.s_TitleAddress;
			parameters[7].Value = model.n_ID;
			parameters[8].Value = model.n_AppID;
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_AppAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AppAddress GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_AppID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_TitleAddress from TCstmr_AppAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_AppAddress model=new IPSP.Model.TCstmr_AppAddress();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AppAddress DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_AppAddress model=new IPSP.Model.TCstmr_AppAddress();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_AppID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_TitleAddress ");
			strSql.Append(" FROM TCstmr_AppAddress ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_AppID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_TitleAddress ");
			strSql.Append(" FROM TCstmr_AppAddress ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_AppAddress T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_AppAddress";
			parameters[1].Value = "n_ID";
