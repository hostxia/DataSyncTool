...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCstmr_IntroConAddress
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ContactID", "TCstmr_IntroConAddress"); 
		}
		...
		public bool Exists(int n_ContactID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TCstmr_IntroConAddress");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_IntroConAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_IntroConAddress(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_IntroConAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_IntroConAddress set ");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_IntroConAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_IntroConAddress GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_ContactID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress from TCstmr_IntroConAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_IntroConAddress model=new IPSP.Model.TCstmr_IntroConAddress();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_IntroConAddress DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_IntroConAddress model=new IPSP.Model.TCstmr_IntroConAddress();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM TCstmr_IntroConAddress ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_IntroConAddress T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_IntroConAddress";
			parameters[1].Value = "n_ID";
