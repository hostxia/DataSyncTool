...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class T_UserRights
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_UserID", "T_UserRights"); 
		}
		...
		public bool Exists(int n_UserID,int n_RightID,int n_ID)
		{
			...
			strSql.Append("select count(1) from T_UserRights");
			strSql.Append(" where n_UserID=@n_UserID and n_RightID=@n_RightID and n_ID=@n_ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_UserRights(");
			strSql.Append("n_UserID,n_RightID)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_UserRights set ");
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_UserRights ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		public IPSP.Model.T_UserRights GetModel(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_UserID,n_RightID from T_UserRights ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.T_UserRights model=new IPSP.Model.T_UserRights();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.T_UserRights DataRowToModel(DataRow row)
		{
			IPSP.Model.T_UserRights model=new IPSP.Model.T_UserRights();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_UserID,n_RightID ");
			strSql.Append(" FROM T_UserRights ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_UserID,n_RightID ");
			strSql.Append(" FROM T_UserRights ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_UserRights T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_UserRights";
