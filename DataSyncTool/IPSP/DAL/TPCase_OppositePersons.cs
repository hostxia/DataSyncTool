/**  版本信息模板在安装目录下，可自行修改。
* TPCase_OppositePersons.cs
*
* 功 能： N/A
* 类 名： TPCase_OppositePersons
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:49:31   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TPCase_OppositePersons
	/// </summary>
	public partial class TPCase_OppositePersons
	{
		public TPCase_OppositePersons()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "TPCase_OppositePersons"); 
		}
		...
		public bool Exists(int n_CaseID,int Patent,int n_ID)
		{
			...
			strSql.Append("select count(1) from TPCase_OppositePersons");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TPCase_OppositePersons model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPCase_OppositePersons(");
			strSql.Append("n_CaseID,s_Role,s_Name,s_OtherName,s_Addr,s_OtherAddr,s_ZipCode,s_Tel,s_Fax,s_Email,s_LawDeputy,s_Contact,Patent,n_Country)");
			...
			parameters[12].Value = model.Patent;
			parameters[13].Value = model.n_Country;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TPCase_OppositePersons model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPCase_OppositePersons set ");
			...
			parameters[14].Value = model.Patent;
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TPCase_OppositePersons ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TPCase_OppositePersons GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_CaseID,s_Role,s_Name,s_OtherName,s_Addr,s_OtherAddr,s_ZipCode,s_Tel,s_Fax,s_Email,s_LawDeputy,s_Contact,Patent,n_Country from TPCase_OppositePersons ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TPCase_OppositePersons model=new IPSP.Model.TPCase_OppositePersons();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TPCase_OppositePersons DataRowToModel(DataRow row)
		{
			IPSP.Model.TPCase_OppositePersons model=new IPSP.Model.TPCase_OppositePersons();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_CaseID,s_Role,s_Name,s_OtherName,s_Addr,s_OtherAddr,s_ZipCode,s_Tel,s_Fax,s_Email,s_LawDeputy,s_Contact,Patent,n_Country ");
			strSql.Append(" FROM TPCase_OppositePersons ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_CaseID,s_Role,s_Name,s_OtherName,s_Addr,s_OtherAddr,s_ZipCode,s_Tel,s_Fax,s_Email,s_LawDeputy,s_Contact,Patent,n_Country ");
			strSql.Append(" FROM TPCase_OppositePersons ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPCase_OppositePersons T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TPCase_OppositePersons";
