...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCode_AnnualFee
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ID", "TCode_AnnualFee"); 
		}
		...
		public bool Exists(int n_ID)
		{
			...
			strSql.Append("select count(1) from TCode_AnnualFee");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCode_AnnualFee model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCode_AnnualFee(");
			strSql.Append("n_RegCountry,n_PatentType,n_YearNo,n_OfficialFee,n_OfficialCurrency,s_UnitPrice,s_Unit,n_ExceedUnit,n_ExceedUnitFee,s_InitialDateType,s_Notes,dt_CreateDate,dt_EditDate,n_Months)");
			strSql.Append(" values (");
			strSql.Append("@n_RegCountry,@n_PatentType,@n_YearNo,@n_OfficialFee,@n_OfficialCurrency,@s_UnitPrice,@s_Unit,@n_ExceedUnit,@n_ExceedUnitFee,@s_InitialDateType,@s_Notes,@dt_CreateDate,@dt_EditDate,@n_Months)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@n_RegCountry", SqlDbType.Int,4),
					new SqlParameter("@n_PatentType", SqlDbType.Int,4),
					...
					new SqlParameter("@n_Months", SqlDbType.Int,4)};
			parameters[0].Value = model.n_RegCountry;
			parameters[1].Value = model.n_PatentType;
			parameters[2].Value = model.n_YearNo;
			parameters[3].Value = model.n_OfficialFee;
			parameters[4].Value = model.n_OfficialCurrency;
			parameters[5].Value = model.s_UnitPrice;
			parameters[6].Value = model.s_Unit;
			parameters[7].Value = model.n_ExceedUnit;
			parameters[8].Value = model.n_ExceedUnitFee;
			parameters[9].Value = model.s_InitialDateType;
			parameters[10].Value = model.s_Notes;
			parameters[11].Value = model.dt_CreateDate;
			parameters[12].Value = model.dt_EditDate;
			parameters[13].Value = model.n_Months;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCode_AnnualFee model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCode_AnnualFee set ");
			strSql.Append("n_RegCountry=@n_RegCountry,");
			strSql.Append("n_PatentType=@n_PatentType,");
			...
			strSql.Append("n_Months=@n_Months");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_RegCountry", SqlDbType.Int,4),
					new SqlParameter("@n_PatentType", SqlDbType.Int,4),
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCode_AnnualFee ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCode_AnnualFee GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_RegCountry,n_PatentType,n_YearNo,n_OfficialFee,n_OfficialCurrency,s_UnitPrice,s_Unit,n_ExceedUnit,n_ExceedUnitFee,s_InitialDateType,s_Notes,dt_CreateDate,dt_EditDate,n_Months from TCode_AnnualFee ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCode_AnnualFee model=new IPSP.Model.TCode_AnnualFee();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCode_AnnualFee DataRowToModel(DataRow row)
		{
			IPSP.Model.TCode_AnnualFee model=new IPSP.Model.TCode_AnnualFee();
			if (row != null)
			{
				...
				if(row["n_PatentType"]!=null && row["n_PatentType"].ToString()!="")
				{
					model.n_PatentType=int.Parse(row["n_PatentType"].ToString());
				}
				...
				if(row["n_Months"]!=null && row["n_Months"].ToString()!="")
				{
					model.n_Months=int.Parse(row["n_Months"].ToString());
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_RegCountry,n_PatentType,n_YearNo,n_OfficialFee,n_OfficialCurrency,s_UnitPrice,s_Unit,n_ExceedUnit,n_ExceedUnitFee,s_InitialDateType,s_Notes,dt_CreateDate,dt_EditDate,n_Months ");
			strSql.Append(" FROM TCode_AnnualFee ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_RegCountry,n_PatentType,n_YearNo,n_OfficialFee,n_OfficialCurrency,s_UnitPrice,s_Unit,n_ExceedUnit,n_ExceedUnitFee,s_InitialDateType,s_Notes,dt_CreateDate,dt_EditDate,n_Months ");
			strSql.Append(" FROM TCode_AnnualFee ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCode_AnnualFee T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCode_AnnualFee";
