...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCstmr_AppContact
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_AppID", "TCstmr_AppContact"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int n_AppID,int n_ContactID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from TCstmr_AppContact");
			strSql.Append(" where n_AppID=@n_AppID and n_ContactID=@n_ContactID ");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_AppContact model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_AppContact(");
			strSql.Append("n_AppID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_Identity,s_Department)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_AppContact model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_AppContact set ");
			...
			parameters[21].Value = model.s_Identity;
			parameters[22].Value = model.s_Department;
			parameters[23].Value = model.n_ContactID;
			parameters[24].Value = model.n_AppID;
		...
		public bool Delete(int n_ContactID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_AppContact ");
			strSql.Append(" where n_ContactID=@n_ContactID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ContactID", SqlDbType.Int,4)
			};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int n_AppID,int n_ContactID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AppContact GetModel(int n_ContactID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ContactID,n_AppID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_Identity,s_Department from TCstmr_AppContact ");
			strSql.Append(" where n_ContactID=@n_ContactID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ContactID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_AppContact model=new IPSP.Model.TCstmr_AppContact();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AppContact DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_AppContact model=new IPSP.Model.TCstmr_AppContact();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ContactID,n_AppID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_Identity,s_Department ");
			strSql.Append(" FROM TCstmr_AppContact ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ContactID,n_AppID,s_FirstName,s_LastName,s_NativeName,s_OtherName,s_IPType,n_Language,s_JobTitle,s_Prefix,s_Phone,s_Mobile,s_Fax,s_Email,s_Website,s_IMAddress,s_Facebook,s_Twitter,s_PreferContact,s_Notes,n_Sequence,dt_CreateDate,dt_EditDate,s_Identity,s_Department ");
			strSql.Append(" FROM TCstmr_AppContact ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_AppContact T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_AppContact";
			parameters[1].Value = "n_ContactID";
