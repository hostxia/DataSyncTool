/**  版本信息模板在安装目录下，可自行修改。
* TCstmr_AgencyAddress.cs
*
* 功 能： N/A
* 类 名： TCstmr_AgencyAddress
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:47:23   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TCstmr_AgencyAddress
	/// </summary>
	public partial class TCstmr_AgencyAddress
	{
		public TCstmr_AgencyAddress()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_AgencyID", "TCstmr_AgencyAddress"); 
		}
		...
		public bool Exists(int n_AgencyID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TCstmr_AgencyAddress");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_AgencyAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_AgencyAddress(");
			strSql.Append("n_AgencyID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_AgencyAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_AgencyAddress set ");
			...
			parameters[9].Value = model.n_AgencyID;
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_AgencyAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AgencyAddress GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_AgencyID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress from TCstmr_AgencyAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_AgencyAddress model=new IPSP.Model.TCstmr_AgencyAddress();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_AgencyAddress DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_AgencyAddress model=new IPSP.Model.TCstmr_AgencyAddress();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_AgencyID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress ");
			strSql.Append(" FROM TCstmr_AgencyAddress ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_AgencyID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress ");
			strSql.Append(" FROM TCstmr_AgencyAddress ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_AgencyAddress T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_AgencyAddress";
			parameters[1].Value = "n_ID";
