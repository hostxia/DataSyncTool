...
{
	/// <summary>
	/// 数据访问类:TFCode_DeadlineInCodeTaskChain
	/// </summary>
	public partial class TFCode_DeadlineInCodeTaskChain
	{
		...
		public bool Exists(Guid g_ID)
		{
			...
			strSql.Append("select count(1) from TFCode_DeadlineInCodeTaskChain");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TFCode_DeadlineInCodeTaskChain(");
			strSql.Append("g_ID,g_CodeTaskChainGuid,g_CodeDeadlineID)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TFCode_DeadlineInCodeTaskChain set ");
		...
		public bool Delete(Guid g_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TFCode_DeadlineInCodeTaskChain ");
			strSql.Append(" where g_ID=@g_ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@g_ID", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = g_ID;
		...
		public IPSP.Model.TFCode_DeadlineInCodeTaskChain GetModel(Guid g_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 g_ID,g_CodeTaskChainGuid,g_CodeDeadlineID from TFCode_DeadlineInCodeTaskChain ");
			strSql.Append(" where g_ID=@g_ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@g_ID", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = g_ID;

			IPSP.Model.TFCode_DeadlineInCodeTaskChain model=new IPSP.Model.TFCode_DeadlineInCodeTaskChain();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TFCode_DeadlineInCodeTaskChain DataRowToModel(DataRow row)
		{
			IPSP.Model.TFCode_DeadlineInCodeTaskChain model=new IPSP.Model.TFCode_DeadlineInCodeTaskChain();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select g_ID,g_CodeTaskChainGuid,g_CodeDeadlineID ");
			strSql.Append(" FROM TFCode_DeadlineInCodeTaskChain ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TFCode_DeadlineInCodeTaskChain T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TFCode_DeadlineInCodeTaskChain";
