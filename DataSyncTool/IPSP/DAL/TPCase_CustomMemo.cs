...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TPCase_CustomMemo
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "TPCase_CustomMemo"); 
		}
		...
		public bool Exists(int n_CaseID)
		{
			...
			strSql.Append("select count(1) from TPCase_CustomMemo");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(IPSP.Model.TPCase_CustomMemo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPCase_CustomMemo(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TPCase_CustomMemo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPCase_CustomMemo set ");
		...
		public bool Delete(int n_CaseID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TPCase_CustomMemo ");
			strSql.Append(" where n_CaseID=@n_CaseID ");
			SqlParameter[] parameters = {
					new SqlParameter("@n_CaseID", SqlDbType.Int,4)			};
			parameters[0].Value = n_CaseID;
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TPCase_CustomMemo GetModel(int n_CaseID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_CaseID,s_Name,s_LicenseNum,dt_ExpiredDate,s_Note,s_AttachedFiles,s_OtherClaim,s_AppNum,dt_ReceiveDate,s_MemoName,dt_CheckDate,dt_ConfirmDate,s_MemoNum,dt_MemoExpireDate from TPCase_CustomMemo ");
			strSql.Append(" where n_CaseID=@n_CaseID ");
			SqlParameter[] parameters = {
					new SqlParameter("@n_CaseID", SqlDbType.Int,4)			};
			parameters[0].Value = n_CaseID;

			IPSP.Model.TPCase_CustomMemo model=new IPSP.Model.TPCase_CustomMemo();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TPCase_CustomMemo DataRowToModel(DataRow row)
		{
			IPSP.Model.TPCase_CustomMemo model=new IPSP.Model.TPCase_CustomMemo();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM TPCase_CustomMemo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPCase_CustomMemo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TPCase_CustomMemo";
