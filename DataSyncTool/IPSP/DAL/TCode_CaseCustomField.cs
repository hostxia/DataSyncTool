/**  版本信息模板在安装目录下，可自行修改。
* TCode_CaseCustomField.cs
*
* 功 能： N/A
* 类 名： TCode_CaseCustomField
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:45:53   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TCode_CaseCustomField
	/// </summary>
	public partial class TCode_CaseCustomField
	{
		public TCode_CaseCustomField()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ID", "TCode_CaseCustomField"); 
		}
		...
		public bool Exists(int n_ID)
		{
			...
			strSql.Append("select count(1) from TCode_CaseCustomField");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCode_CaseCustomField model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCode_CaseCustomField(");
			strSql.Append("s_IPType,s_Business,s_CustomFieldName,s_Type,s_Content,s_IsActive,dt_CreateDate,dt_EditDate)");
			strSql.Append(" values (");
			strSql.Append("@s_IPType,@s_Business,@s_CustomFieldName,@s_Type,@s_Content,@s_IsActive,@dt_CreateDate,@dt_EditDate)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@s_IPType", SqlDbType.NVarChar,1),
					new SqlParameter("@s_Business", SqlDbType.NVarChar,300),
			...
			parameters[1].Value = model.s_Business;
			parameters[2].Value = model.s_CustomFieldName;
			parameters[3].Value = model.s_Type;
			parameters[4].Value = model.s_Content;
			parameters[5].Value = model.s_IsActive;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCode_CaseCustomField model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCode_CaseCustomField set ");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCode_CaseCustomField ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCode_CaseCustomField GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,s_IPType,s_Business,s_CustomFieldName,s_Type,s_Content,s_IsActive,dt_CreateDate,dt_EditDate from TCode_CaseCustomField ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCode_CaseCustomField model=new IPSP.Model.TCode_CaseCustomField();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCode_CaseCustomField DataRowToModel(DataRow row)
		{
			IPSP.Model.TCode_CaseCustomField model=new IPSP.Model.TCode_CaseCustomField();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,s_IPType,s_Business,s_CustomFieldName,s_Type,s_Content,s_IsActive,dt_CreateDate,dt_EditDate ");
			strSql.Append(" FROM TCode_CaseCustomField ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,s_IPType,s_Business,s_CustomFieldName,s_Type,s_Content,s_IsActive,dt_CreateDate,dt_EditDate ");
			strSql.Append(" FROM TCode_CaseCustomField ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCode_CaseCustomField T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCode_CaseCustomField";
