...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TPCase_ReviewInfo
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "TPCase_ReviewInfo"); 
		}
		...
		public bool Exists(int n_CaseID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TPCase_ReviewInfo");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TPCase_ReviewInfo ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_CaseID,dt_RejectDate,s_Reason ");
			strSql.Append(" FROM TPCase_ReviewInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_CaseID,dt_RejectDate,s_Reason ");
			strSql.Append(" FROM TPCase_ReviewInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPCase_ReviewInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TPCase_ReviewInfo";
			parameters[1].Value = "n_ID";
