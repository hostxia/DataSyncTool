/**  版本信息模板在安装目录下，可自行修改。
* TCstmr_IntroAddress.cs
*
* 功 能： N/A
* 类 名： TCstmr_IntroAddress
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:47:57   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TCstmr_IntroAddress
	/// </summary>
	public partial class TCstmr_IntroAddress
	{
		public TCstmr_IntroAddress()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_IntroID", "TCstmr_IntroAddress"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int n_IntroID,int n_ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from TCstmr_IntroAddress");
			strSql.Append(" where n_IntroID=@n_IntroID and n_ID=@n_ID ");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_IntroAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_IntroAddress(");
			strSql.Append("n_IntroID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_IntroAddress model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_IntroAddress set ");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_IntroAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int n_IntroID,int n_ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_IntroAddress GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_IntroID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress from TCstmr_IntroAddress ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_IntroAddress model=new IPSP.Model.TCstmr_IntroAddress();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_IntroAddress DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_IntroAddress model=new IPSP.Model.TCstmr_IntroAddress();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_IntroID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress ");
			strSql.Append(" FROM TCstmr_IntroAddress ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_IntroID,n_Country,s_State,s_City,s_Street,s_ZipCode,s_Type,s_Country,s_IsMailingAddress ");
			strSql.Append(" FROM TCstmr_IntroAddress ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_IntroAddress T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_IntroAddress";
			parameters[1].Value = "n_ID";
