/**  版本信息模板在安装目录下，可自行修改。
* TTCase_CustomMemo.cs
*
* 功 能： N/A
* 类 名： TTCase_CustomMemo
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/2/28 17:50:28   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:TTCase_CustomMemo
	/// </summary>
	public partial class TTCase_CustomMemo
	{
		public TTCase_CustomMemo()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "TTCase_CustomMemo"); 
		}
		...
		public bool Exists(int n_CaseID)
		{
			...
			strSql.Append("select count(1) from TTCase_CustomMemo");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(IPSP.Model.TTCase_CustomMemo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TTCase_CustomMemo(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TTCase_CustomMemo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TTCase_CustomMemo set ");
		...
		public bool Delete(int n_CaseID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TTCase_CustomMemo ");
			strSql.Append(" where n_CaseID=@n_CaseID ");
			SqlParameter[] parameters = {
					new SqlParameter("@n_CaseID", SqlDbType.Int,4)			};
			parameters[0].Value = n_CaseID;
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TTCase_CustomMemo GetModel(int n_CaseID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_CaseID,s_Name,s_LicenseNum,dt_ExpiredDate,s_Note,s_AttachedFiles,s_OtherClaim,s_AppNum,dt_ReceiveDate,s_MemoName,dt_CheckDate,dt_ConfirmDate,s_MemoNum,dt_MemoExpireDate from TTCase_CustomMemo ");
			strSql.Append(" where n_CaseID=@n_CaseID ");
			SqlParameter[] parameters = {
					new SqlParameter("@n_CaseID", SqlDbType.Int,4)			};
			parameters[0].Value = n_CaseID;

			IPSP.Model.TTCase_CustomMemo model=new IPSP.Model.TTCase_CustomMemo();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TTCase_CustomMemo DataRowToModel(DataRow row)
		{
			IPSP.Model.TTCase_CustomMemo model=new IPSP.Model.TTCase_CustomMemo();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_CaseID,s_Name,s_LicenseNum,dt_ExpiredDate,s_Note,s_AttachedFiles,s_OtherClaim,s_AppNum,dt_ReceiveDate,s_MemoName,dt_CheckDate,dt_ConfirmDate,s_MemoNum,dt_MemoExpireDate ");
			strSql.Append(" FROM TTCase_CustomMemo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TTCase_CustomMemo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TTCase_CustomMemo";
