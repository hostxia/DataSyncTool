...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCode_ProxyServer
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ID", "TCode_ProxyServer"); 
		}
		...
		public bool Exists(int n_ID)
		{
			...
			strSql.Append("select count(1) from TCode_ProxyServer");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCode_ProxyServer model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCode_ProxyServer set ");
			strSql.Append("s_ProxyServer=@s_ProxyServer,");
			strSql.Append("s_Port=@s_Port,");
			strSql.Append("s_UserName=@s_UserName,");
			strSql.Append("s_Password=@s_Password,");
			strSql.Append("s_Domain=@s_Domain,");
			strSql.Append("s_IfProxy=@s_IfProxy");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@s_ProxyServer", SqlDbType.NVarChar,50),
					new SqlParameter("@s_Port", SqlDbType.NVarChar,10),
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCode_ProxyServer ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCode_ProxyServer DataRowToModel(DataRow row)
		{
			IPSP.Model.TCode_ProxyServer model=new IPSP.Model.TCode_ProxyServer();
			if (row != null)
			{
				...
				if(row["s_ProxyServer"]!=null)
				{
					model.s_ProxyServer=row["s_ProxyServer"].ToString();
				}
				if(row["s_Port"]!=null)
				{
				...
				if(row["s_Domain"]!=null)
				{
					model.s_Domain=row["s_Domain"].ToString();
				}
				if(row["s_IfProxy"]!=null)
				{
					model.s_IfProxy=row["s_IfProxy"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,s_ProxyServer,s_Port,s_UserName,s_Password,s_Domain,s_IfProxy ");
			strSql.Append(" FROM TCode_ProxyServer ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,s_ProxyServer,s_Port,s_UserName,s_Password,s_Domain,s_IfProxy ");
			strSql.Append(" FROM TCode_ProxyServer ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCode_ProxyServer T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCode_ProxyServer";
