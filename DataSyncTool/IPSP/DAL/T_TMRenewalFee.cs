...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class T_TMRenewalFee
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "T_TMRenewalFee"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int n_CaseID,int n_BillID,int n_TRenewalFeeID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from T_TMRenewalFee");
			strSql.Append(" where n_CaseID=@n_CaseID and n_BillID=@n_BillID and n_TRenewalFeeID=@n_TRenewalFeeID ");
			SqlParameter[] parameters = {
					new SqlParameter("@n_CaseID", SqlDbType.Int,4),
					new SqlParameter("@n_BillID", SqlDbType.Int,4),
					new SqlParameter("@n_TRenewalFeeID", SqlDbType.Int,4)			};
			parameters[0].Value = n_CaseID;
			parameters[1].Value = n_BillID;
			parameters[2].Value = n_TRenewalFeeID;
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.T_TMRenewalFee model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_TMRenewalFee(");
			strSql.Append("n_CaseID,s_Status,s_PayMode,s_StatusOrder,n_ChargeCurrency,n_ChargeOFee,n_ChargeAFee,n_ChargeTFee,dt_ChargeShldPayDate,dt_ChargePayDate,n_OfficialCurrency,n_OfficialFee,n_OfficialLateFee,s_IsOfficialDisc,s_OfficialDiscStyle,n_OfficialDiscount,dt_OfficialShldPayDate,dt_OfficialPayDate,s_OfficialReceiptPath,n_PayFeeListID,s_Notes,s_InvoiceNum,dt_AlarmDate,n_Rate,s_IsActive,dt_CreateDate,dt_EditDate,dt_Consign,dt_Publish,s_PubNum,s_PubIssue,s_PubVol,s_RenewalFilePath,dt_Effective,dt_End,dt_NextRenewal,s_RenewalStatus,s_FeeReceiveCashStatue,n_ExchangeCurrency,s_FeeReceivedStatus,s_Creator,s_Editor,n_BillID)");
			...
			parameters[28].Value = model.dt_Publish;
			parameters[29].Value = model.s_PubNum;
			parameters[30].Value = model.s_PubIssue;
			parameters[31].Value = model.s_PubVol;
			parameters[32].Value = model.s_RenewalFilePath;
			parameters[33].Value = model.dt_Effective;
			parameters[34].Value = model.dt_End;
			parameters[35].Value = model.dt_NextRenewal;
			parameters[36].Value = model.s_RenewalStatus;
			parameters[37].Value = model.s_FeeReceiveCashStatue;
			parameters[38].Value = model.n_ExchangeCurrency;
			parameters[39].Value = model.s_FeeReceivedStatus;
			parameters[40].Value = model.s_Creator;
			parameters[41].Value = model.s_Editor;
			parameters[42].Value = model.n_BillID;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.T_TMRenewalFee model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_TMRenewalFee set ");
			...
			strSql.Append(" where n_TRenewalFeeID=@n_TRenewalFeeID");
			SqlParameter[] parameters = {
					new SqlParameter("@s_Status", SqlDbType.NVarChar,50),
					new SqlParameter("@s_PayMode", SqlDbType.NVarChar,2),
					new SqlParameter("@s_StatusOrder", SqlDbType.NVarChar,50),
			...
			parameters[27].Value = model.dt_Publish;
			parameters[28].Value = model.s_PubNum;
			parameters[29].Value = model.s_PubIssue;
			parameters[30].Value = model.s_PubVol;
			parameters[31].Value = model.s_RenewalFilePath;
			parameters[32].Value = model.dt_Effective;
			parameters[33].Value = model.dt_End;
			parameters[34].Value = model.dt_NextRenewal;
			parameters[35].Value = model.s_RenewalStatus;
			parameters[36].Value = model.s_FeeReceiveCashStatue;
			parameters[37].Value = model.n_ExchangeCurrency;
			parameters[38].Value = model.s_FeeReceivedStatus;
			parameters[39].Value = model.s_Creator;
			parameters[40].Value = model.s_Editor;
			parameters[41].Value = model.n_TRenewalFeeID;
			parameters[42].Value = model.n_CaseID;
			parameters[43].Value = model.n_BillID;
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int n_TRenewalFeeID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_TMRenewalFee ");
			strSql.Append(" where n_TRenewalFeeID=@n_TRenewalFeeID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_TRenewalFeeID", SqlDbType.Int,4)
			};
			parameters[0].Value = n_TRenewalFeeID;
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int n_CaseID,int n_BillID,int n_TRenewalFeeID)
		{
		...
		/// 批量删除数据
		/// </summary>
		public bool DeleteList(string n_TRenewalFeeIDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_TMRenewalFee ");
			strSql.Append(" where n_TRenewalFeeID in ("+n_TRenewalFeeIDlist + ")  ");
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.T_TMRenewalFee GetModel(int n_TRenewalFeeID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_TRenewalFeeID,n_CaseID,s_Status,s_PayMode,s_StatusOrder,n_ChargeCurrency,n_ChargeOFee,n_ChargeAFee,n_ChargeTFee,dt_ChargeShldPayDate,dt_ChargePayDate,n_OfficialCurrency,n_OfficialFee,n_OfficialLateFee,s_IsOfficialDisc,s_OfficialDiscStyle,n_OfficialDiscount,dt_OfficialShldPayDate,dt_OfficialPayDate,s_OfficialReceiptPath,n_PayFeeListID,s_Notes,s_InvoiceNum,dt_AlarmDate,n_Rate,s_IsActive,dt_CreateDate,dt_EditDate,dt_Consign,dt_Publish,s_PubNum,s_PubIssue,s_PubVol,s_RenewalFilePath,dt_Effective,dt_End,dt_NextRenewal,s_RenewalStatus,s_FeeReceiveCashStatue,n_ExchangeCurrency,s_FeeReceivedStatus,s_Creator,s_Editor,n_BillID from T_TMRenewalFee ");
			strSql.Append(" where n_TRenewalFeeID=@n_TRenewalFeeID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_TRenewalFeeID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.T_TMRenewalFee model=new IPSP.Model.T_TMRenewalFee();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.T_TMRenewalFee DataRowToModel(DataRow row)
		{
			IPSP.Model.T_TMRenewalFee model=new IPSP.Model.T_TMRenewalFee();
			if (row != null)
			{
				if(row["n_TRenewalFeeID"]!=null && row["n_TRenewalFeeID"].ToString()!="")
				{
					model.n_TRenewalFeeID=int.Parse(row["n_TRenewalFeeID"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_TRenewalFeeID,n_CaseID,s_Status,s_PayMode,s_StatusOrder,n_ChargeCurrency,n_ChargeOFee,n_ChargeAFee,n_ChargeTFee,dt_ChargeShldPayDate,dt_ChargePayDate,n_OfficialCurrency,n_OfficialFee,n_OfficialLateFee,s_IsOfficialDisc,s_OfficialDiscStyle,n_OfficialDiscount,dt_OfficialShldPayDate,dt_OfficialPayDate,s_OfficialReceiptPath,n_PayFeeListID,s_Notes,s_InvoiceNum,dt_AlarmDate,n_Rate,s_IsActive,dt_CreateDate,dt_EditDate,dt_Consign,dt_Publish,s_PubNum,s_PubIssue,s_PubVol,s_RenewalFilePath,dt_Effective,dt_End,dt_NextRenewal,s_RenewalStatus,s_FeeReceiveCashStatue,n_ExchangeCurrency,s_FeeReceivedStatus,s_Creator,s_Editor,n_BillID ");
			strSql.Append(" FROM T_TMRenewalFee ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_TRenewalFeeID,n_CaseID,s_Status,s_PayMode,s_StatusOrder,n_ChargeCurrency,n_ChargeOFee,n_ChargeAFee,n_ChargeTFee,dt_ChargeShldPayDate,dt_ChargePayDate,n_OfficialCurrency,n_OfficialFee,n_OfficialLateFee,s_IsOfficialDisc,s_OfficialDiscStyle,n_OfficialDiscount,dt_OfficialShldPayDate,dt_OfficialPayDate,s_OfficialReceiptPath,n_PayFeeListID,s_Notes,s_InvoiceNum,dt_AlarmDate,n_Rate,s_IsActive,dt_CreateDate,dt_EditDate,dt_Consign,dt_Publish,s_PubNum,s_PubIssue,s_PubVol,s_RenewalFilePath,dt_Effective,dt_End,dt_NextRenewal,s_RenewalStatus,s_FeeReceiveCashStatue,n_ExchangeCurrency,s_FeeReceivedStatus,s_Creator,s_Editor,n_BillID ");
			strSql.Append(" FROM T_TMRenewalFee ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.n_TRenewalFeeID desc");
			}
			strSql.Append(")AS Row, T.*  from T_TMRenewalFee T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_TMRenewalFee";
			parameters[1].Value = "n_TRenewalFeeID";
