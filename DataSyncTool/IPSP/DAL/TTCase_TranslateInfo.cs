...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TTCase_TranslateInfo
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_CaseID", "TTCase_TranslateInfo"); 
		}
		...
		public bool Exists(int n_CaseID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TTCase_TranslateInfo");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TTCase_TranslateInfo ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_CaseID,n_OrigLan,n_OrigWordsNum,n_DestLan,s_Translator,dt_TransAssignDate,dt_TransLtdDate,dt_TransEndDate,s_TransQuality,s_Collator1,s_Collator2,dt_CollateAssignDate,dt_CollateLtdDate,dt_CollateEndDate,s_TypeWriteBy,n_OwnCaseID,n_TranslatorID,n_Collator1ID,n_Collator2ID,n_TypeWriteByID ");
			strSql.Append(" FROM TTCase_TranslateInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_CaseID,n_OrigLan,n_OrigWordsNum,n_DestLan,s_Translator,dt_TransAssignDate,dt_TransLtdDate,dt_TransEndDate,s_TransQuality,s_Collator1,s_Collator2,dt_CollateAssignDate,dt_CollateLtdDate,dt_CollateEndDate,s_TypeWriteBy,n_OwnCaseID,n_TranslatorID,n_Collator1ID,n_Collator2ID,n_TypeWriteByID ");
			strSql.Append(" FROM TTCase_TranslateInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TTCase_TranslateInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TTCase_TranslateInfo";
			parameters[1].Value = "n_ID";
