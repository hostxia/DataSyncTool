...
namespace DataSyncTool.IPSP.DAL
{
	...
	public partial class TCstmr_ClientFile
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("n_ClientID", "TCstmr_ClientFile"); 
		}
		...
		public bool Exists(int n_ClientID,int n_ID)
		{
			...
			strSql.Append("select count(1) from TCstmr_ClientFile");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(IPSP.Model.TCstmr_ClientFile model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TCstmr_ClientFile(");
			strSql.Append("n_ClientID,s_Name,s_Description,s_FilePath,dt_EditDate,dt_CreateDate)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IPSP.Model.TCstmr_ClientFile model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TCstmr_ClientFile set ");
		...
		public bool Delete(int n_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TCstmr_ClientFile ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_ClientFile GetModel(int n_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 n_ID,n_ClientID,s_Name,s_Description,s_FilePath,dt_EditDate,dt_CreateDate from TCstmr_ClientFile ");
			strSql.Append(" where n_ID=@n_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@n_ID", SqlDbType.Int,4)
			};
			...
			IPSP.Model.TCstmr_ClientFile model=new IPSP.Model.TCstmr_ClientFile();
		...
		/// 得到一个对象实体
		/// </summary>
		public IPSP.Model.TCstmr_ClientFile DataRowToModel(DataRow row)
		{
			IPSP.Model.TCstmr_ClientFile model=new IPSP.Model.TCstmr_ClientFile();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select n_ID,n_ClientID,s_Name,s_Description,s_FilePath,dt_EditDate,dt_CreateDate ");
			strSql.Append(" FROM TCstmr_ClientFile ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" n_ID,n_ClientID,s_Name,s_Description,s_FilePath,dt_EditDate,dt_CreateDate ");
			strSql.Append(" FROM TCstmr_ClientFile ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TCstmr_ClientFile T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TCstmr_ClientFile";
			parameters[1].Value = "n_ID";
