...
namespace DataSyncTool.PC.BLL
{
	...
	public partial class SBFEEDETAIL
	{
		...
		{
			return dal.Exists(CASENO,CLIENTNO,VOUCHERNO,FEETYPE,AMOUNT,PAYMETHOD,PAYDATE,TRADEMARKNAME);
		}
		...
		public bool Delete(string CASENO,string CLIENTNO,string VOUCHERNO,string FEETYPE,decimal AMOUNT,string PAYMETHOD,DateTime PAYDATE,string TRADEMARKNAME)
		{
			...
			return dal.Delete(CASENO,CLIENTNO,VOUCHERNO,FEETYPE,AMOUNT,PAYMETHOD,PAYDATE,TRADEMARKNAME);
		}
