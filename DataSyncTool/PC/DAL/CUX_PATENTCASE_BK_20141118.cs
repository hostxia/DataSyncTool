...
namespace DataSyncTool.PC.DAL
{
	...
	public partial class CUX_PATENTCASE_BK_20141118
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Model.CUX_PATENTCASE_BK_20141118 model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.CUX_PATENTCASE_BK_20141118 model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.CUX_PATENTCASE_BK_20141118 GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			...
			Model.CUX_PATENTCASE_BK_20141118 model=new Model.CUX_PATENTCASE_BK_20141118();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.CUX_PATENTCASE_BK_20141118 DataRowToModel(DataRow row)
		{
			Model.CUX_PATENTCASE_BK_20141118 model=new Model.CUX_PATENTCASE_BK_20141118();
			if (row != null)
			{
