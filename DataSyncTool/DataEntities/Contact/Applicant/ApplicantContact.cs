...
{
    [Persistent("TCstmr_AppContact")]
    public class ApplicantContact : XPLiteObject
    {
        ...
        public ApplicantContact(Session session) : base(session)
        {
        }

        public ApplicantContact() : base(Session.DefaultSession)
        {
        }
        ...
        [Aggregated, Association("AppConAddress", typeof (ApplicantContactAddress))]
        public XPCollection AppConAddress
        {
            get { return GetCollection("AppConAddress"); }
        }
        ...
        public string sZipCode
        {
            get
            {
                ApplicantContactAddress applicantContactAddress =
                    AppConAddress.Cast<ApplicantContactAddress>()
                        .FirstOrDefault(s => s.s_Type != null && s.s_Type.ToUpper().IndexOf("O") >= 0);
                return applicantContactAddress != null ? applicantContactAddress.s_ZipCode : string.Empty;
            }
        }
        ...
        public string sCountry
        {
            get
            {
                string sCountryName = "";
                foreach (
                    ApplicantContactAddress address in
                        AppConAddress.Cast<ApplicantContactAddress>()
        ...
        public string sStreet
        {
            get
            {
                ApplicantContactAddress applicantContactAddress =
                    AppConAddress.Cast<ApplicantContactAddress>()
                        .FirstOrDefault(s => s.s_Type != null && s.s_Type.ToUpper().IndexOf("O") >= 0);
                return applicantContactAddress != null ? applicantContactAddress.s_Street : string.Empty;
            }
        }
        ...
        public string sCity
        {
            get
            {
                ApplicantContactAddress applicantContactAddress =
                    AppConAddress.Cast<ApplicantContactAddress>()
                        .FirstOrDefault(s => s.s_Type != null && s.s_Type.ToUpper().IndexOf("O") >= 0);
                return applicantContactAddress != null ? applicantContactAddress.s_City : string.Empty;
            }
        }
        ...
        public string sStreetAll
        {
            get
            {
                ApplicantContactAddress applicantContactAddress =
                    AppConAddress.Cast<ApplicantContactAddress>()
                        .FirstOrDefault(s => s.s_Type != null && s.s_Type.ToUpper().IndexOf("O") >= 0);
                return applicantContactAddress != null ? applicantContactAddress.s_StreetAll : string.Empty;
            }
        }
        ...
        {
            foreach (ApplicantContactAddress appConAddress in AppConAddress)
            {
        ...
        public string GetOfficeCNAddress()
        {
            ...
            foreach (ApplicantContactAddress appConAddress in AppConAddress)
            {
                ...
                return sLanguage.ToString() == "zh-CN"
                    ? appConAddress.s_State + " " + appConAddress.s_City + " " + appConAddress.s_Street
                    : appConAddress.s_Street + " " + appConAddress.s_City + " " + appConAddress.s_State;
            }
        ...
        {
            string sCountryName = "";
            foreach (ApplicantContactAddress address in AppConAddress)
            {
        ...
        ///     Kevin Wang(2010-10-25)
        /// </summary>
        /// <returns>中文办公邮编</returns>
        public string GetOfficeCNZipCode()
        {
            //this.Reload();
            int i = AppConAddress.Count;
            foreach (ApplicantContactAddress appConAddress in AppConAddress)
            {
                if (appConAddress.s_Type == null || appConAddress.s_Type.IndexOf("O") < 0) continue;
                return appConAddress.s_ZipCode;
            }
            return "";
        }
        ...
        ///     Kevin Wang(2010-10-25)
        /// </summary>
        /// <returns>外文办公邮编</returns>
        public string GetOfficeENZipCode()
        {
            foreach (ApplicantContactAddress appConAddress in AppConAddress)
            {
                if (appConAddress.s_Type == null || appConAddress.s_Type.IndexOf("E") < 0) continue;
        ...
        public string Address1Type
        {
            get
            {
                return AppConAddress.Count < 1 ? string.Empty : ((ApplicantContactAddress)AppConAddress[0]).s_Type;
            }
        }
        ...
        public string Address1
        {
            get
            {
                return AppConAddress.Count < 1 ? string.Empty : GetFullAddress((ApplicantContactAddress)AppConAddress[0]);
            }
        }
        ...
        public string Address1EN
        {
            get
            {
                return AppConAddress.Count < 1 ? string.Empty : GetFullAddress((ApplicantContactAddress)AppConAddress[0], "en-US");
            }
        }
        ...
        public string Address1Street
        {
            get
            {
                return AppConAddress.Count < 1 ? string.Empty : ((ApplicantContactAddress)AppConAddress[0]).s_Street;
            }
        }
        ...
        public string Address1ZipCode
        {
            get
            {
                return AppConAddress.Count < 1 ? string.Empty : ((ApplicantContactAddress)AppConAddress[0]).s_ZipCode;
            }
        }
        ...
        public string Address2Type
        {
            get
            {
                return AppConAddress.Count < 2 ? string.Empty : ((ApplicantContactAddress)AppConAddress[1]).s_Type;
            }
        }
        ...
        public string Address2
        {
            get
            {
                return AppConAddress.Count < 2 ? string.Empty : GetFullAddress((ApplicantContactAddress)AppConAddress[1]);
            }
        }
        ...
        public string Address2EN
        {
            get
            {
                return AppConAddress.Count < 2 ? string.Empty : GetFullAddress((ApplicantContactAddress)AppConAddress[1], "en-US");
            }
        }
        ...
        public string Address2Street
        {
            get
            {
                return AppConAddress.Count < 2 ? string.Empty : ((ApplicantContactAddress)AppConAddress[1]).s_Street;
            }
        }
        ...
        public string Address2ZipCode
        {
            get
            {
                return AppConAddress.Count < 2 ? string.Empty : ((ApplicantContactAddress)AppConAddress[1]).s_ZipCode;
            }
        }
        ...
        public String Address3Type
        {
            get
            {
                return AppConAddress.Count < 3 ? string.Empty : ((ApplicantContactAddress)AppConAddress[2]).s_Type;
            }
        }
        ...
        public String Address3
        {
            get
            {
                return AppConAddress.Count < 3 ? string.Empty : GetFullAddress((ApplicantContactAddress)AppConAddress[2]);
            }
        }
        ...
        public String Address3EN
        {
            get
            {
                return AppConAddress.Count < 3 ? string.Empty : GetFullAddress((ApplicantContactAddress)AppConAddress[2], "en-US");
            }
        }
        ...
        public String Address3Street
        {
            get
            {
                return AppConAddress.Count < 3 ? string.Empty : ((ApplicantContactAddress)AppConAddress[2]).s_Street;
            }
        }
        ...
        public String Address3ZipCode
        {
            get
            {
                return AppConAddress.Count < 3 ? string.Empty : ((ApplicantContactAddress)AppConAddress[2]).s_ZipCode;
            }
        }

        public string GetFullAddress(ApplicantContactAddress address, string sLanguage = "zh-CN")
        {
            switch (sLanguage)
            {
                case "zh-CN":
