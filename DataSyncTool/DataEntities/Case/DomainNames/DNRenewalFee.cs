...
{
    [Persistent("T_DNRenewalFee")]
    public class DNRenewalFee : XPLiteObject
    {
        private BasicDomain basicDomain;
        ...
        public DNRenewalFee(Session session) : base(session)
        {
        }

        public DNRenewalFee() : base(Session.DefaultSession)
        {
        }
        ...
        {
            get { return fn_DRenewalFeeID; }
            set { SetPropertyValue<int>("n_DRenewalFeeID", ref fn_DRenewalFeeID, value); }
        }
        ...
        [Persistent("n_CaseID")]
        [Association("BasicDomain-DNRenewalFee")]
        public BasicDomain TheBasicDomain
        {
            get { return basicDomain; }
            set { SetPropertyValue("n_CaseID", ref basicDomain, value); }
        }
