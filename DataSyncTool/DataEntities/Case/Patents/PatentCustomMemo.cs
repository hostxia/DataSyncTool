...
namespace DataEntities.Case.Patents
{
    ...
    [Persistent("TPCase_CustomMemo")]
    public class CasePatentCustomMemo : ExtendedPatent
    {
        ...
        public CasePatentCustomMemo(Session session) : base(session)
        {
        }

        public CasePatentCustomMemo() : base(Session.DefaultSession)
        {
        }
        ...
        [Aggregated, Association("CustomMemo-Tortious", typeof (PatentTortiousWare))]
