...
{
    [Persistent("TCode_TRenewalFee")]
    public class CodeTrademarkRenewalFee : XPLiteObject
    {
        ...
        public CodeTrademarkRenewalFee(Session session) : base(session)
        {
        }

        public CodeTrademarkRenewalFee() : base(Session.DefaultSession)
        {
        }
        ...
        [Aggregated, Association("TrademarkRenewalFeeItems", typeof (CodeTrademarkRenewalFeeItem))]
        public XPCollection TrademarkRenewalFeeItems
        {
            get { return GetCollection("TrademarkRenewalFeeItems"); }
        }
