...
namespace DataSyncTool.BLL
{
	...
	{
		private readonly DataSyncTool.DAL.BILLCODE_V2 dal=new DataSyncTool.DAL.BILLCODE_V2();
		public BILLCODE_V2()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DataSyncTool.Model.BILLCODE_V2 GetModelByCache(string CODE,string GROUPID,string TYPES)
		{
			...
			return (DataSyncTool.Model.BILLCODE_V2)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DataSyncTool.Model.BILLCODE_V2> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DataSyncTool.Model.BILLCODE_V2> DataTableToList(DataTable dt)
		{
			List<DataSyncTool.Model.BILLCODE_V2> modelList = new List<DataSyncTool.Model.BILLCODE_V2>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DataSyncTool.Model.BILLCODE_V2 model;
