...
namespace DataSyncTool.BLL
{
	...
	{
		private readonly DataSyncTool.DAL.FCASE dal=new DataSyncTool.DAL.FCASE();
		public FCASE()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DataSyncTool.Model.FCASE GetModelByCache(string OURNO)
		{
			...
			return (DataSyncTool.Model.FCASE)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DataSyncTool.Model.FCASE> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DataSyncTool.Model.FCASE> DataTableToList(DataTable dt)
		{
			List<DataSyncTool.Model.FCASE> modelList = new List<DataSyncTool.Model.FCASE>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DataSyncTool.Model.FCASE model;
