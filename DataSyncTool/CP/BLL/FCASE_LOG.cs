...
namespace DataSyncTool.BLL
{
	...
	{
		private readonly DataSyncTool.DAL.FCASE_LOG dal=new DataSyncTool.DAL.FCASE_LOG();
		public FCASE_LOG()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DataSyncTool.Model.FCASE_LOG GetModelByCache(string PID)
		{
			...
			return (DataSyncTool.Model.FCASE_LOG)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DataSyncTool.Model.FCASE_LOG> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DataSyncTool.Model.FCASE_LOG> DataTableToList(DataTable dt)
		{
			List<DataSyncTool.Model.FCASE_LOG> modelList = new List<DataSyncTool.Model.FCASE_LOG>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DataSyncTool.Model.FCASE_LOG model;
