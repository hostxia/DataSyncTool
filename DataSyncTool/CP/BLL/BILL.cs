...
namespace DataSyncTool.CP.BLL
{
	...
	public partial class BILL
	{
		...
		{
			return dal.DeleteList(PageValidate.SafeLongFilter(NOTENUMBERlist,0) );
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.BILL GetModelByCache(string NOTENUMBER)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.BILL> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.BILL> DataTableToList(DataTable dt)
		{
			List<Model.BILL> modelList = new List<Model.BILL>();
