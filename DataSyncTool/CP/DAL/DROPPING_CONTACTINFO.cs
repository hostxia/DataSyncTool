...
namespace DataSyncTool.DAL
{
	...
	public partial class DROPPING_CONTACTINFO
	{
		...
		public DataSyncTool.Model.DROPPING_CONTACTINFO GetModel()
		{
			...
			DataSyncTool.Model.DROPPING_CONTACTINFO model=new DataSyncTool.Model.DROPPING_CONTACTINFO();
		...
		/// 得到一个对象实体
		/// </summary>
		public DataSyncTool.Model.DROPPING_CONTACTINFO DataRowToModel(DataRow row)
		{
			DataSyncTool.Model.DROPPING_CONTACTINFO model=new DataSyncTool.Model.DROPPING_CONTACTINFO();
			if (row != null)
			{
