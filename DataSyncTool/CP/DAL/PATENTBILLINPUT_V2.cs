...
namespace DataSyncTool.DAL
{
	...
	public partial class PATENTBILLINPUT_V2
	{
		...
		public DataSyncTool.Model.PATENTBILLINPUT_V2 GetModel(string PID)
		{
			...
			DataSyncTool.Model.PATENTBILLINPUT_V2 model=new DataSyncTool.Model.PATENTBILLINPUT_V2();
		...
		/// 得到一个对象实体
		/// </summary>
		public DataSyncTool.Model.PATENTBILLINPUT_V2 DataRowToModel(DataRow row)
		{
			DataSyncTool.Model.PATENTBILLINPUT_V2 model=new DataSyncTool.Model.PATENTBILLINPUT_V2();
			if (row != null)
			{
