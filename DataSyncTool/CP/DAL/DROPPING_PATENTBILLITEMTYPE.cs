...
namespace DataSyncTool.DAL
{
	...
	public partial class DROPPING_PATENTBILLITEMTYPE
	{
		...
		public bool Exists(string BILLCODE)
		{
			...
			strSql.Append("select count(1) from DROPPING_PATENTBILLITEMTYPE");
		...
		public bool Delete(string BILLCODE)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DROPPING_PATENTBILLITEMTYPE ");
			strSql.Append(" where BILLCODE=:BILLCODE ");
			OracleParameter[] parameters = {
					new OracleParameter(":BILLCODE", OracleType.VarChar,30)			};
			parameters[0].Value = BILLCODE;
		...
		public DataSyncTool.Model.DROPPING_PATENTBILLITEMTYPE GetModel(string BILLCODE)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select BILLCODE,BILLTEXT,PATENTCASETYPE,HASQUANTITY,UNIT,DEFOFFICIALFEE,DEFNONOFFICIALFEE,ALGORITHM,F0,F1,F2,F3,F4,F5,COMMENTS from DROPPING_PATENTBILLITEMTYPE ");
			strSql.Append(" where BILLCODE=:BILLCODE ");
			OracleParameter[] parameters = {
					new OracleParameter(":BILLCODE", OracleType.VarChar,30)			};
			parameters[0].Value = BILLCODE;
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM DROPPING_PATENTBILLITEMTYPE ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DROPPING_PATENTBILLITEMTYPE T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DROPPING_PATENTBILLITEMTYPE";
