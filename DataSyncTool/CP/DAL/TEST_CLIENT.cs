...
namespace DataSyncTool.CP.DAL
{
	...
	public partial class TEST_CLIENT
	{
		...
		public bool Add(Model.TEST_CLIENT model)
		{
			...
			strSql.Append("CLIENT_NUMBER,NAME1,NAME2)");
			strSql.Append(" values (");
			strSql.Append(":CLIENT_NUMBER,:NAME1,:NAME2)");
			OracleParameter[] parameters = {
					new OracleParameter(":CLIENT_NUMBER", OracleType.VarChar,10),
					new OracleParameter(":NAME1", OracleType.VarChar,400),
					new OracleParameter(":NAME2", OracleType.VarChar,400)};
			parameters[0].Value = model.CLIENT_NUMBER;
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TEST_CLIENT ");
			strSql.Append(" where ");
			OracleParameter[] parameters = {
			};
		...
		public Model.TEST_CLIENT GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CLIENT_NUMBER,NAME1,NAME2 from TEST_CLIENT ");
			strSql.Append(" where ");
			OracleParameter[] parameters = {
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CLIENT_NUMBER,NAME1,NAME2 ");
			strSql.Append(" FROM TEST_CLIENT ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM TEST_CLIENT ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TEST_CLIENT T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TEST_CLIENT";
